...
func TestSeats(t *testing.T) {
	tests := []struct {
		...
		{"Gitpod: unlimited seats", 0, 1000, true, false, false, licenseTypeGitpod},
		{"Gitpod: within limited seats", 50, 40, true, false, false, licenseTypeGitpod},
		{"Gitpod: within limited seats (edge)", 50, 50, true, false, false, licenseTypeGitpod},
		{"Gitpod: beyond limited seats", 50, 150, false, false, false, licenseTypeGitpod},
		{"Gitpod: beyond limited seats (edge)", 50, 51, false, false, false, licenseTypeGitpod},
		{"Gitpod: invalid license", 50, 50, false, false, true, licenseTypeGitpod},
		{"Gitpod: within default license seats", 0, 7, true, true, false, licenseTypeGitpod},
		{"Gitpod: within default license seats (edge)", 0, 10, true, true, false, licenseTypeGitpod},
		{"Gitpod: beyond default license seats", 0, 11, false, true, false, licenseTypeGitpod},

		// correctly missing the default license tests as Replicated always has a license
		{"Replicated: unlimited seats", 0, 1000, true, false, false, licenseTypeReplicated},
		{"Replicated: within limited seats", 50, 40, true, false, false, licenseTypeReplicated},
		{"Replicated: within limited seats (edge)", 50, 50, true, false, false, licenseTypeReplicated},
		{"Replicated: beyond limited seats", 50, 150, false, false, false, licenseTypeReplicated},
		{"Replicated: beyond limited seats (edge)", 50, 51, false, false, false, licenseTypeReplicated},
		{"Replicated: invalid license", 50, 50, false, false, true, licenseTypeReplicated},
		{"Replicated: beyond default license seats", 0, 11, false, true, false, licenseTypeReplicated},
	}
